...
**Architecture triangle (Proposition 22):** Recognition (banned), tracking (banned), dynamics (current frontier). Post-ban, the substrate lives at the dynamics vertex. Proposition 29 refines this: at the dynamics vertex, the architecture degree of freedom (how $h$ is computed) is **provably irrelevant** for Hebbian action learning. The sole degree of freedom is the exploration mechanism — how actions are selected during the bootstrap phase.
