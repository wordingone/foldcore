#!/usr/bin/env python3
"""
Step 388 -- Raw centered dot product, NO rescaling. LS20 64x64. 50K steps.
...
def main():
    t0=time.time()
    print(f"Step 388 -- Raw centered dot product, no rescaling. 64x64. 50K.",flush=True)
    ...
    print("STEP 388 SUMMARY",flush=True); print("="*60,flush=True)
