"""
Step 683 — 674 on LS20, seed 3 only, 300s cap.
Same as 686 but seed 3. L1 at 2402.
"""
import numpy as np
import time
import sys
...
def main():
    ...
    print(f"Step 683: seed {SEED}, {PER_SEED_TIME}s cap")
    ...
    elif l1: print("FINDING: L1 reached, L2 not reached — budget confirmed not bottleneck")
