#!/usr/bin/env python3
"""
Step 389 -- Raw centered dot product, 200K steps. Statistical test.

Same as 388 but 4x longer. Does level 1 fall from raw pixels?
...
def main():
    t0=time.time()
    print(f"Step 389 -- Raw centered dot product. 64x64. 200K steps.",flush=True)
    ...
    print("STEP 389 SUMMARY",flush=True); print("="*60,flush=True)
