"""
Step 690 — 674 on LS20, 20 seeds (full sweep).

Step 674 got 9/10 on seeds 0-9. Run seeds 0-19 for definitive L1 count.
674 substrate: k=12 nav + k=20 fine at aliased cells. Binary aliasing.
20 seeds, 25s cap. Report L1 count and aliased_cells per seed.
"""
import numpy as np
import time
import sys
...
def main():
    ...
    print(f"Step 690: 674 on LS20, {N_SEEDS} seeds, {PER_SEED_TIME}s cap")
    ...
    for r in results:
        print(f"  s{r['seed']:2d}: L1={r['l1']} L2={r['l2']}")
    if l1_n >= 18: print("FINDING: 674 achieves L1 on nearly all seeds")
    elif l1_n >= 15: print("FINDING: 674 strong majority L1")
