#!/usr/bin/env python3
"""
Step 390b -- Raw centered dot product, NO rescaling. LS20 64x64. 50K steps.
...
D = 4096; CB_CAP = 1000; THRESH_INT = 100; MEAN_BOOT = 200
...
def main():
    t0=time.time()
    print(f"Step 390b -- Raw centered dot product, no rescaling. 64x64. 50K.",flush=True)
    ...
    print("STEP 390b SUMMARY",flush=True); print("="*60,flush=True)
