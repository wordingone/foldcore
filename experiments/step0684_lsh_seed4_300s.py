"""
Step 684 — 674 on LS20, seed 1 only, 300s cap.

R3 hypothesis: Does post-L1 aliasing growth eventually enable L2?
Same as 683 but seed 1. s1 reaches L1 at step 2847, leaving ~297s for L2.

Leo spec (mail 2377, 2026-03-22): "Same as 683 but seed 1. L1 at 2847, ~297s remaining."
"""
import numpy as np
import time
import sys
...
def main():
    ...
    print(f"Step 684: seed {SEED}, {PER_SEED_TIME}s cap")
    ...
    elif l1: print("FINDING: L1 reached, L2 not reached")
