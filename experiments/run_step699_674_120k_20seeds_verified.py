"""
Step 699 — 674 at 120K, 20 seeds, game version verified.

Repeat of Step 692 with explicit game version confirmation.
Compare directly against Step 697 (plain k=12 current baseline).
...
def main():
    ...
    t_start = time.time()
    print(f"Step 699: 674 on LS20, {N_SEEDS} seeds, {MAX_STEPS-1} steps cap")
    print(f"Game version: ls20/9607627b (current — verify in init log above)")
    ...
    if l1_n >= 19: print("FINDING: 674 achieves near-complete L1 coverage at 120K")
    elif l1_n >= 18: print("FINDING: 674 maintains high L1 coverage at 120K")
    else: print(f"MARGINAL: L1={l1_n}/{N_SEEDS} — below 18/20 threshold")
