"""
step1004_multihorizon.py -- Multi-horizon prediction (K-step-ahead credit).
...
class MultiHorizon1004:
    ...
    def process(self, obs):
        ...
        delta_combined = self.delta_per_action + LONG_MIX * self.delta_long_per_action[:self._n_actions]
...
def run_chain(seeds, n_steps, cifar_steps, cifar_imgs, cifar_lbls):
    c1l, lsl, ftl, c2l = [], [], [], []
    for seed in seeds:
        sub = MultiHorizon1004(seed=seed)
...
if __name__ == "__main__":
    import os
    print("=" * 70)
    print("STEP 1004 — MULTI-HORIZON PREDICTION (K=10 step-ahead credit)")
    print("=" * 70)
    ...
    print()
    print("=" * 70)
    print("STEP 1004 RESULTS (916 baseline: LS20~72.7, FT09=0):")
