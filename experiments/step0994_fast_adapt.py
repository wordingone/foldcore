"""
step0994_fast_adapt.py -- Fast adapt phase triggered by h-novelty spike.
...
if __name__ == "__main__":
    import os
    print("=" * 70)
    print("STEP 994 — FAST ADAPT (h-novelty spike → 500-step 1.5x eta)")
    print("=" * 70)
    ...
    print(f"Kill: LS20<65.9  Success: LS20 improves or FT09>0")
    print()
    ...
    print()
    print("=" * 70)
    print("STEP 994 RESULTS (992 baseline: LS20=65.9):")
