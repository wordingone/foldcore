...
CURRENT STEP: 1019a KILL. **FT09 zone ablation: exact coords required (zones FAIL).** L5/L6 are Lights-Out puzzles (GF(2) Gaussian elimination). Next: 1019b (order ablation) + 1020a (VC33 zones). Sequence: ablation → RHAE API scoring → debate.
