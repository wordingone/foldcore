...
CURRENT STEP: **Steps 1088-1089 done. Defense v21 still peak.** v23 anti-oscillation FAIL (interference). v24 run-and-tumble marginal (20% L1, ARC=0.0003). Prosecution Rule 15 rejection: can't borrow defense's reactive switching. Prosecution v22 (directional attention-trajectory) spec sent as Step 1091. Defense v25 (Step 1090) running. Compression done (Hart audit, PB28 revised, PB30 new). 1091+ experiments.
