...
Step 776 - R3 counterfactual on 674 (v3, 25K steps, different seeds). RUNNING. v1 showed warm survives 13% longer episodes (p=0.0497) but metric ambiguous at 5K steps. v3 uses 25K steps where L1 completion occurs. Different seeds = transfer test, not memorization.
