...
CURRENT STEP: **Steps 1104-1145: 45 experiments. 0% wall = DISCOVERY GAP (PB19).** v30 ONLY draw-robust result (ARC=0.33). Every axis closed: encoding (avgpool4/Sobel/raw 4096D), goal (distance/change/novelty/temporal), action space (keyboard/block clicks/4096 pixel scan), patience (3-200 step holds), forward models (EMA/random/alpha). 0% games produce NO detectable change to ANY action at ANY resolution with ANY patience. PB19: "Generic exploration = 0 even unconstrained. Prescribed solution = 6/6." The bottleneck is DISCOVERY, not perception/encoding/action. 1145+ experiments.
  ...
  **Step 1146 SIGNAL (defense v56, state-conditioned action, graph ban LIFTED):** LSH→256 states, per-(state,action) EMA effect. ARC=0.0001, **3/5 L1**. GAME_2 L1=100% SOLVED=100% max_lvl=1. First 3/5 from non-v30 architecture in 46-experiment sprint. State-conditioned selection shows signal. Draw-robustness TBD.
