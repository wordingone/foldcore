...
CURRENT STEP: **Steps 1104-1150: 50 experiments. 0% wall = DISCOVERY GAP (PB19).** v30 ONLY draw-robust result (ARC=0.33). State-conditioned action (v56, graph ban lift) = marginal signal on 2/3 draws but not robust. Prosecution v38 (direction vectors) = same wall. 50 experiments across every axis: encoding (4 types), goal (6 types), action space (4 types), patience (3-200 steps), forward models (3 types), novelty (3 types), state-conditioning (2 types), action sequences (1 type). PB19 confirmed: "Generic exploration = 0 even unconstrained." Bottleneck = DISCOVERY. 1150+ experiments.
