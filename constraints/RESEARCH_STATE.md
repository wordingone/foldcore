...
INFRASTRUCTURE FIXES 1-5 COMMITTED (df602b5): step budgets, GymWrapper, R3 counterfactual in judge, set_state on BaseSubstrate, MIN_SEEDS=10. Fixes 4/7/8 (calibration baselines, multimodal test, constraint caveats) pending.
