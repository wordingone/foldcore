...
CURRENT STEP: **Steps 1104-1132: 30 experiments DEFINITIVE. v30 ONLY draw-robust result.** ALL click successes draw-dependent (v40, v43, v46 — each solved 1 click game on lucky draw, failed reproduction). 0% wall = STRUCTURAL. ~60% of draws contain games no probing strategy reaches. Defense ceiling: v30 ARC=0.33 on keyboard games. Click games: unsolved robustly by either side. 1132+ experiments. Both sides rethinking.
