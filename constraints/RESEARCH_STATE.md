...
Step 934b RUNNING - Epistemic action selection (Prop 24 full formula): G[a] = predicted_change / confidence_a. The confidence denominator (1/pred_error_ema) is the discriminator — separates well-modeled resets (high conf) from novel transitions (low conf). 934 proved numerator alone fails; 934b adds the denominator.
