...
CURRENT STEP: **DEBATE v3 EXPERIMENT RACE (Step 1023).** Separability CONFIRMED: mode map discovery works identically with graph/random/800b (15/15 VC33 L1). RHAE=0.0006 (first non-zero click game without banned components). Graph contributed ZERO to discovery. Next: extend beyond L1, test FT09.
