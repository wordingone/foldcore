...
CURRENT STEP: **Steps 1105-1106: both prosecution Gap attacks FAIL.** v26 uncertainty-directed ARC=0 (forward model can't distinguish actions). v27 level-transition ARC=0 (L1=0 blocks transition detection). **Step 1104 (v30 draw-robustness) PENDING — the decisive test.** 1107+ experiments.
