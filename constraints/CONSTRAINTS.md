...
- **LS20 action 0 dominance (Steps 778-784v2, 2026-03-23).** LS20 navigation is dominated by action 0 repetition: momentum (70% repeat) = 217/seed, cycling cold (action 0 first) = 226/seed, while action-diversifying mechanisms (prediction-contrast, ensemble, round-robin) = 0/seed. This makes LS20 uninformative for testing post-ban action selection mechanisms. FT09 (68 actions, diverse clicks) is a better test environment. The "targeted exploration kills navigation" finding (Steps 477-482) may be LS20-specific: those strategies diversified away from action 0.
