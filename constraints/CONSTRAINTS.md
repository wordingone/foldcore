...
| PB31 | **Encoding resolution is the bottleneck (Step 1101).** avgpool8 (64D) too coarse — game changes invisible. avgpool4 (256D, 4×4 blocks) reveals them. Defense v30 = v21 reactive + avgpool4 → ARC=0.4701 (highest single-game ARC). TWO independent defense families hit same 2/5 wall with avgpool8 (Steps 1098-1100) → wall dissolved with avgpool4. Draw-robustness pending. | **PROVISIONAL** (Step 1101, single draw. Draw-robustness needed before CONFIRMED.) |
