...
| PB26 | ℓ_π (encoding modification) vs ℓ₁ (parameter modification). Early sprint: 2-2-1, confounded. Step 1067: v14 (ℓ_π) = 80%/70%/0% vs v16 (ℓ₁ 4096-dim SPSA) = 0%/0%/0%. **Step 1069: v17 (ℓ₁ block-reduced 64-dim SPSA) = NO ZERO GAMES (5/5 L1 > 0).** Concession #7 challenged: v16 failure was dimensionality (4096-dim SPSA intractable), not ℓ₁ inferiority. When SPSA gets reduced dims (64), it matches ℓ_π. ANIL direction (Raghu et al., ICLR 2020) holds but mechanism comparison confounded by dimensionality. | **PROVISIONAL** (Steps 1042-1069. v14 vs v16 was dimensionality-confounded, not ℓ-level-confounded. Same-seed controlled run needed.) |
