...
7. **Non-RL paradigms untested.** Imitation learning (on prescribed solutions), IRL (infer reward from demonstrations), evolutionary search, active learning (uncertainty reduction) — all R1-compatible, none tested.
