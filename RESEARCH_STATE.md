...
| **498** | **FT09 pen10K + 200K steps** | — | **17%** | **0/5. 32/32 cells, go=112-113, deterministic.** FT09 CLOSED — same pattern as LS20 Level 2. Safe space fully mapped (32 states), win behind death-gate. pen=0 dies too much, pen10K survives but blocked. No sweet spot. Win requires SPECIFIC SEQUENCED ACTIONS that random exploration cannot discover. All three games (LS20 L2, FT09, VC33) share this pattern. I6/I9 (purposeful exploration) is THE bottleneck. |
