...
| **477** | **Softmax action selection (T=0.1, 1.0, 10.0) on k-means** | — | **25%** | **Argmin wins. Stochasticity hurts.** T=0.1: 0/3 (worse). T=1.0: 2/3. T=10.0: 2/3. True argmin: 3/3 at same seeds. Deterministic tie-breaking is optimal. The 5-6/10 ceiling is NOT in action selection. NOT in encoding, partitioning, multi-hash, or stochasticity. Ceiling is unknown — the game has more structure than argmin can exploit. |
