...
| **480** | **Projection selection (10 probes, pick best sig_q)** | — | **25%** | **1/5. sig_q at 2K not predictive.** All probes score similarly (0.25-0.48). The bottleneck is the GAME TRAJECTORY, not the projection — seed luck is upstream of the hash function. 28 experiments (456-480): the 6/10 wall is fundamental to random exploration. Not encoding, partitioning, action selection, or projection quality. The random walk's trajectory through the game determines success. |
