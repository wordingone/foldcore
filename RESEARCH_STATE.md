...
| **540** | **Absorb + reducible-entropy filter** | — | **1/3 L1@158816** | **SIGNAL.** Filter tracks whether past refinements reduced entropy. Seed 1 navigates at ratio=0.74. Deaths still ~800/100K (0.5 cutoff too permissive). Seed 2 oscillates at boundary (0.53-0.60). Not kill — signal is real but weak. |
