...
| **467** | **LSH k=12 on FT09** | — | **17%** | **Still degenerate. 1 cell / 4096.** avgpool16 + centered_enc produces identical vectors for ALL FT09 frames. Not a k problem — preprocessing destroys FT09's visual structure. FT09 needs different encoding (higher resolution, diff frames, or raw pixels) or is fundamentally blocked without correct click actions. Cross-game generality NOT confirmed. |
