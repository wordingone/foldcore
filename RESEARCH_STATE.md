...
| **529** | **LSH Level 2 extended budget (740K steps)** | — | **0/3 L2, 439 cells** | **Plateau confirmed.** Growth rate ~2 cells/100K at saturation. Asymptote ~440-450 cells. L2 structurally disconnected — not a budget issue. Seed 2 burst: L1@505K after 500K stuck (dud LSH seed eventually navigates, 10x slower). Death rate: 1 per 130 steps. |
