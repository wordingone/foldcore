...
| **474** | **L2 k-means centroids + graph (FAMILY #8)** | — | **25%** | **5/5 at 50K. NEW RECORD.** L2 nearest-centroid mapping (n=300, frozen after 1K warmup). Data-aligned partitioning BEATS random LSH (6/10). Steps=[1980, 4347, 16263, 17588, 17807]. Near-full occupancy (97%). Lower sig_q (0.082) but higher reliability — occupancy compensates. Data alignment IS the lever. Family #8, experiment 1/20. |
