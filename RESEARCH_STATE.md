...
| **476** | **L2 k-means on FT09 + VC33** | — | **varies** | **FT09: 32 visual states, 0/3. VC33: 50 visual states, 0/3.** k-means perfectly captures game structure (32 cells, 50 cells) but sig_q=0 — argmin can't discriminate actions. NOT an encoding problem. The mechanism (edge-count argmin) can't solve click-targeting or timing games. Action selection is the bottleneck. |
