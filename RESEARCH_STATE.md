...
| **479** | **UCB1 action selection (C=0.5-5.0) on LSH** | — | **25%** | **All C identical = argmin.** UCB degenerates because exploration bonus always dominates at this cell/step ratio. 26 experiments (466-479): EVERY mechanism lever exhausted. The 6/10 ceiling is the probability that random k=12 hyperplanes happen to separate LS20's corridor structure. Seed luck = projection quality. |
