...
| **531** | **LSH k sweep on LS20 (k=8,12,16,20)** | — | **k=16/20 KILL k=12** | k=8: 2/3 (92 cells). k=12: 2/3 (425 cells). **k=16: 3/3 (1094 cells). k=20: 3/3 (1605 cells).** Fastest L1: k=20@10246. "k=12 optimal" (Step 458) was budget-dependent at 50K. At 200K, finer partition wins — more cells = less argmin cycling. **k=16 is the new baseline.** |
