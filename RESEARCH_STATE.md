...
| **473** | **Multi-hash LSH (L=1,3,5 tables) on LS20** | — | **25%** | **ALL 2/5. Neutral.** Multiple hash tables add nothing. Seed luck is not in the hash function. Pattern: Steps 466-473 all give ~2/5 — every variant noise around baseline. centered_enc + avgpool16 + k=12 + single table = 6/10 is the plateau. |
