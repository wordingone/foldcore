...
| **589** | **Recode vs LSH head-to-head (20 seeds, 50K)** | — | **K CONFOUND** | Recode(K=16) 18/20 = LSH(K=16) 18/20 > LSH(K=12) 13/20. ℓ_π advantage is entirely explained by K=16 bits. Adaptive splitting adds nothing on top of K. **Proposition 6 prediction FAILS.** Hierarchy is descriptive, not predictive. |
