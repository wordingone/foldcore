...
| **489** | **Level 2 brute force (1M steps)** | — | **25%** | **NOT FOUND at 1M steps.** Cells plateau at 259/4096 — no new discovery after 800K. U25 CONVERGENCE CONFIRMED: argmin locally converges when all (cell, action) pairs visited. Agent cycles 259 states forever. Level 1 works because reward reachable before convergence (471 steps). Level 2 reward unreachable — convergence traps at 259 cells. The anti-convergence mechanism (U25-U17 coupling) is exactly what's needed for multi-level. |
