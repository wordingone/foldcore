...
| **528** | **Level 2 stochastic edge exploitation (Jun's script)** | — | **0/3 L2, 434 cells** | **CORRECTS 259-cell ceiling.** Seeds 0/1 reach 381/434 cells at 500K steps (was 259 at 50K). The 259 ceiling was TIME LIMIT, not topology. 20 stochastic edges (H=3.5-4.0, 20-30 destinations) — near-random, not exploitable. Stochastic pursuit (BFS+exploit) completed all 20 targets, no effect. L2 still 0/3. Seed 2: 111 cells, no L1 (LSH seed variance). **Level 2 is reward-disconnected at 434 cells, not topology-bounded at 259.** arcagi3 wrapper built. |
