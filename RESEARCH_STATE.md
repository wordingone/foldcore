...
| **449** | **CA-graph (Rule 110 + edges)** | — | **25%** | **LEVEL 1 at step 4081 (1/3 seeds). 6x faster than cosine graph.** ratio=0.047 (sweet spot compression). unique=469. No cosine, no attract, no prototypes. **4th architecture family NAVIGATES. First non-codebook-mediated navigation.** |
